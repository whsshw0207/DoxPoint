...
const BOARD_REVIEWS: BoardReview[] = [
  { name: "sun***", rating: 5, review: "친절하게 너무 잘 알려주시고 당연한 걸 알려주시는 게 아닌 진짜 제 문제를 알려주셔서 좋았습니다 다음에 시간이랑 돈이 된다면... ㅋㅋ 다른 포지션으로도 몇 번이고 더 받아보고 싶은 강의입니다" },
  { name: "경관_***", rating: 5, review: "진짜 혼자서는 모를 내용이나 지나쳤을 내용들을 세세히 알려주셔서 좋았습니다. 앞으로의 방향성을 잡아줬다는 점에서 너무 만족했습니다" },
  { name: "mon***", rating: 5, review: "저도 리플을 많이 봤지만, 제가 보지못했던 디테일한 부분까지 짚어주셔서 정말 좋은 시간이었습니다. 다음에는 말씀하신부분을 수정해서 다시 수강신청하겠습니다. 말씀 감사하고 고생많으셨습니다!!" },
  { name: "대장장***", rating: 5, review: "쉽게 잘 설명해주시고 전문적으로 설명해줍니다. 2시간이라는 시간이 순삭이었습니다." },
  ...
  { name: "달려들***", rating: 5, review: "초보 유저인데 잘 인지하지 못하고 있던 부분을 상세히 잘 알려주셔서 그 방법으로 연습하고 실력 늘고 다시 배우러오겠습니다" },
  { name: "기병_***", rating: 5, review: "너무 친절하시고 티어에 맞게 설명 및 연습방법을 알려주십니다" },
  { name: "달을_***", rating: 5, review: "방향성도 못잡고 있었는데 자세하게 하나하나 다 봐주시고 앞으로 어떻게 해야할지도 잘 알려주셔서 좋았습니다. 피드백 받기전 다이아에서 마스터3까지 올라왔습니다. 다음에도 또 배우러 오겠습니다!" },
  { name: "T1A***", rating: 5, review: "엄청 꼼꼼하게 잘 가르쳐 주십니다." },
  { name: "끝판왕***", rating: 5, review: "딜러 겐지, 트레 피드백 받았는데 섭딜의 기본부터 제가 몰랐었던 부분도 알려주시고 게임 운영도 설명해주셔서 많은 것을 배울 수 있었습니다. 마지막에 설명 끝난 후 피드백 적용됐는지 인게임에 들어가서 봐주시는데 이런 부분도 너무 좋았어요" },
  { name: "고무_***", rating: 5, review: "딜러 피드백을 받았는데 우선 제가 준비한 리플레이 보면서 좋았던 점, 개선해야할 점 알기 쉽게 알려주십니다. 리플레이 피드백 다음 경쟁전 플레이를 봐주시는데 피드백 받았던걸 신경쓰면서 하니 평소 같았으면 졌다고 생각했을 판도 이겨지는게 신기했습니다. 강의중에 플레이 했던 판도 따로 리플레이 피드백 해주시는데 시간이 넘어가도 다 해주셔서 너무 감사했습니다. 질문에 대한 답변도 만족스러워 이후 피드백을 원한다면 저는 고민없이 독스님께 받을 예정입니다." },
  { name: "xod***", rating: 5, review: "옵치 강의의 희망입니다. 일정조율도 잘되시고 부족한 여러 부분들에 대해서도 잘 알려주십니다. 탱 디테일이나 기본기, 영웅별 상황 등 좋습니다" },
  { name: "MB7***", rating: 5, review: "오랜만에 옵치를 시작하는데 변한게 너무 많아서 수강신청했는데 너무 친절하시게 알려주셔서 너무 유익했습니다!" },
  { name: "아이치***", rating: 5, review: "그냥 말이 필요 없습니다" },
  { name: "WiF***", rating: 5, review: "처음에 많이 긴장했는데 친절하게 알려주시고 정확한 문제점과 연습법도 알려주셔서 좋았습니다" },
  { name: "폭주_***", rating: 5, review: "긴장했는데 친절하게 해주셔서 이해도 잘되고 좋았습니다. 감사합니다" },
  { name: "내선***", rating: 5, review: "감사합니다. 간과하고 있던 것들을 정말정말 디테일하게 알려주셨어요. 도움 많이 되었습니다." },
  { name: "거리의***", rating: 5, review: "상세하고 친절하게 가르쳐주십니다" },
  { name: "tou***", rating: 5, review: "한달 피드백 추천드립니다. 이게 저번 피드백의 연장선으로 피드백 받는 게 되게 효과가 좋더라구요. 모두 코치님께 비법소스 야무지게 받으시고 건승하세요." },
  { name: "경의_***", rating: 5, review: "강의 전에 제가 배우고 싶은 부분을 먼저 확인해주시고, 그에 맞춰 자세히 도와주셔서 정말 좋았습니다. 전체적인 설명도 이해하기 쉽게 해주셔서 많은 도움이 되었어요. 추천합니다!" },
  { name: "힘_신***", rating: 5, review: "몰랐던 부분을 배우게 되어서 너무 좋았습니다! 당연히 스펙에 어울리는 전문성과, 초보자도 알기 쉽게 설명하시는 티칭 실력이 강의를 더욱 완벽하게 만듭니다 :) 강력히 추천드립니다." },
  { name: "모르는***", rating: 5, review: "리플 확인하면서 어떤 지점에서 아쉬웠는지 등 자세히 가르쳐주셨습니다. 에임 연습도 어떻게 해야하는지 알려주셔서 좋았습니다." },
  ...
  { name: "성헌***", rating: 5, review: "강의 내용이 전문적이라 좋았습니다!" },
  { name: "바텀은***", rating: 5, review: "성향 파악도 확실히 해 주셔서 어떤 부분이 약점인지 잘 짚어주세요. 전체적인 개념을 보강하면서, 내 약점을 극복하면 어떤 긍정적인 상황들이 전개되는지 잘 알려주십니다. 다들 들어보세요~!" },
  { name: "Jaz***", rating: 5, review: "도움 많이 되었습니다!" },
  { name: "정지***", rating: 5, review: "정말 친절하시고 제가 놓치던 부분이나 문제점 잘 알려주시고 잘 몰랐던거 쉽게 알려주셨습니다. 정말 좋은 강의였습니다. 수고 많으셨습니다." },
  { name: "opg***", rating: 5, review: "평소 모르던 제 플레이에 문제점을 알수있는 시간이었습니다" },
  { name: "선생님***", rating: 5, review: "2달된 뉴비 입장에서도 엄청 쉽게 눈높이 맞춤으로 설명해주십니다. 처음이라 2시간 강의 받아봤는데 2시간 이미 훌쩍 넘겼는데도 짜증 하나 없이 끝까지 피드백 문서를 따로 써주시고 궁금한거 모든거 다 받아주십니다. 혹시 티어에 욕심있으신분은 꼭 이분 강의 들어보셨으면 좋을거같습니다. 하나하나 자세히 알려주시며 제가 따로 이 부분이 더 궁금하다 하면 그 부분을 자세히 뜯어서 알려주시기에 티어 향상에 매우 도움됩니다. 저는 피드백 받은거 연습하고 재수강 예정입니다." },
  { name: "대깨옵***", rating: 5, review: "너무 유익한 강의였습니다. 기본적인 틀에서 점점 세부적으로 확장시켜 알려나가주셔서 이후에 실시간 플레이를 보며 적용시킬때 수월했습니다. 또 구매하겠습니다!" },
  { name: "은빛_***", rating: 5, review: "확실한 것 하나 배웠습니다. 실력향상을 위해 좋은 선택이었습니다." },
  { name: "선물_***", rating: 5, review: "감사합니다." },
  { name: "왕_말***", rating: 5, review: "자리 관련 싸움에서 포지션이 해야 할 것을 상세하게 설명을 받았습니다. 만족합니다." },
  { name: "tou***", rating: 5, review: "복귀한 후로 천년만년 플다에 살다가, 코치님 피드백 받고 마스터로 금세 올라간 사람입니다. 복귀유저라 키리코도 낯설어했던 저 같은 사람을 개과천선 시켜주셨습니다." },
  { name: "반품된***", rating: 5, review: "플레랑 다이아 사이에서 헤매이고 있었는데 길잡이가 되어주는 수업이였습니다. 꼼꼼하게 봐주시고 질문이 많아도 다 답해주셔서 백과사전 느낌이였습니다. 특히 에임에 대해 궁금한 점들이 있었는데 디테일하게 봐주시고 혼자서 연습해 볼 수 있게 피드백해주셨습니다" },
  { name: "신해***", rating: 5, review: "너무 좋았습니다. 알려주신대로만 하니 다이아 딜러 상대로 압도하는 모습을 보였습니다. 감사합니다." },
  { name: "지존라***", rating: 5, review: "후기가 없어서 처음엔 조금 걱정됐지만, 코치님의 경력사항을 보고 믿고 구매했습니다. 초반에 약간의 이슈가 있었지만 피드백을 바로 반영해주시고, 시간을 더 들여 꼼꼼히 알려주시는 모습이 인상 깊었습니다. 다음에는 더 좋은 강의로 다시 뵐 수 있을 것 같아 기대됩니다. 감사합니다!" },
  ...
  { name: "살상연***", rating: 5, review: "1개의 리플레이 분석으로 제 약점을 전부 간파하셨습니다. 심지어 리플레이에 담겨있지 않는 부분까지 전부 알아내셨고 자세한 피드백을 주셨습니다. 알려주신 피드백을 체화하고 다시 신청드릴 예정입니다." },
  { name: "페트리***", rating: 5, review: "몰랐던 부분까지 세세히 잘 가르쳐주십니다" },
  { name: "나무꾼***", rating: 5, review: "굿입니다" },
  { name: "전설의***", rating: 5, review: "게임 이해도가 넘사벽이라 다음에 정기수강 들으려합니다 최고에요" },
  { name: "자칭작***", rating: 5, review: "처음 강의를 받아 봤는데 저의 문제점을 딱 지적해주셔서 도움이 많이 된듯 합니다. 플레이 방향성도 몰랐는데 앞으로 개선하면서 나갈 수 있다고 생각이 들었습니다!" },
  { name: "T1A8**", rating: 5, review: "3회차 강의 잘 받았습니다. 감사합니다!" },
  { name: "왕_말***", rating: 5, review: "복귀 후 기본기 관련하여 첫 강의를 받아보았습니다. 오버워치라는 게임이 에임도 에임이지만 자리 싸움이 가장 중요하다는 것에 대해 상세하게 설명을 들었습니다. 첫 강의에서 만족하는건 흔치 않은데 좋았습니다." },
  { name: "웅이***", rating: 5, review: "예전에 옵치1 초창기에 조금 하다가 접고 다시 복귀해서 게임중인데 게임이 너무 어려워서 강의신청하게되었습니다. 하나하나 세심하게 강의생 눈높이에 맞추셔서 아주 친절하게 이해될때까지 알려주시고, 단점과 장점을 상세히 짚어주시면서 현재 어떤 위치인지 무엇을 더 신경써야 하는지 바른길잡이처럼 피드백 주시는게 너무나도 좋았습니다!!" },
  { name: "tou***", rating: 5, review: "게임 이해를 쉽게 해주시고, 생각하면서 하게끔 만들어주세요. 아는 것도 많아져서 수행하는 재미가 생깁니다." },

];

const MARQUEE_REVIEWS: MarqueeReview[] = [
  { name: "HAN***", rating: 5, review: "거의 1년 정도 피드백 받으면서 문제점을 정확히 짚어주시고, 끝까지 디테일하게 피드백해 주신 덕분에 유의미한 티어 상승이 있었습니다. 취미여도 못하면 스트레스를 크게 받는 사람이라 정말 큰 도움 되었습니다. 감사합니다!", fromTier: "브론즈 2", toTier: "다이아 3" },
  { name: "Dra***", rating: 5, review: "현 오버워치 프로팀에서 활동하시는 코치님답게 전문성있게 잘 가르쳐주십니다. 상황별 대처방법이라던지 티어향상하는데 큰 도움이 된것 같습니다. 감사합니다.", fromTier: "플레티넘 5", toTier: "마스터 5" },
  { name: "qtw***", rating: 5, review: "리퍼 플레티넘4에서 마스터5까지 35승 1무 6패로 달성했습니다. 감사합니다!", fromTier: "플레티넘 4", toTier: "마스터 5" },
  ...
  { name: "qtwt**", rating: 5, review: "힐러도 브리 원챔으로 다이아4에서 마스터5까지 22승 2패로 달렸습니다. 그마까지 달리기 레츠고!", fromTier: "다이아 4", toTier: "마스터 5" },{ name: "이멀**", rating: 5, review: "최근에 일이 생겨서 게임을 잘 못하다 그마 승급전까지 갔습니다", fromTier: "다이아 3", toTier: "마스터 1" },
  ...
  { name: "Sog***", rating: 5, review: "실버5에서 골드2로 올랐습니다 감사합니다.", fromTier: "실버 5", toTier: "골드 2" },
  ...
  { name: "go***", rating: 5, review: "피드백으로 오늘 본계도 다이아4에서 마스터 달성했습니다~ 감사합니다 제일 약했던 콜로세움으로 달성했네용", fromTier: "다이아 4", toTier: "마스터 3" },
  ...
  { name: "pop***", rating: 5, review: "피드백 받기 전에는 겨우겨우 한번 가던 티어를 피드백 이후로는 너무나도 쉽게 갔습니다. 선생님의 친절하고 디테일한 코칭에 늘 생각하며 게임하니 진정으로 게임하는법을 깨닫게 되는거 같습니다. 계속 강의 들을 예정입니다 ㅎㅎ", fromTier: "플래티넘", toTier: "다이아몬드" },
  { name: "T1A-***", rating: 5, review: "이번이 한 달 강의의 2회차인데 너무 만족스럽고 좋았습니다.", fromTier: "다이아", toTier: "마스터" },
  { name: "qtw***", rating: 5, review: "2주간 수련 끝에 브리 원챔 그마 찍었습니다. 딜러는 플레4에서 마스터5(단 3일), 힐러는 다이아4에서 그마5까지 성공했습니다!", fromTier: "다이아 4", toTier: "그랜드마스터 5" },
];
