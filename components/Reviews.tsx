...
const BOARD_REVIEWS: BoardReview[] = [
  ...
  { name: "살상연희**", rating: 5, review: "1개의 리플레이 분석으로 제 약점을 전부 간파하셨습니다. 심지어 리플레이에 담겨있지 않는 부분까지 전부 알아내셨고 자세한 피드백을 주셨습니다. 알려주신 피드백을 체화하고 다시 신청드릴 예정입니다." },
  { name: "페트리사**", rating: 5, review: "몰랐던 부분까지 세세히 잘 가르쳐주십니다" },
  { name: "나무꾼_**", rating: 5, review: "굿입니다" },
  { name: "전설의_**", rating: 5, review: "게임 이해도가 넘사벽이라 다음에 정기수강 들으려합니다 최고에요" },
  { name: "자칭작가**", rating: 5, review: "처음 강의를 받아 봤는데 저의 문제점을 딱 지적해주셔서 도움이 많이 된듯 합니다. 플레이 방향성도 몰랐는데 앞으로 개선하면서 나갈 수 있다고 생각이 들었습니다!" },
  { name: "T1A-**", rating: 5, review: "3회차 강의 잘 받았습니다. 감사합니다!" },
  { name: "왕_말자**", rating: 5, review: "자리 관련 싸움에서 포지션이 해야 할 것을 상세하게 설명을 받았습니다. 강의는 항상 그랬듯이 나쁘지 않습니다. 만족합니다." },
  { name: "왕_말자**", rating: 5, review: "복귀 후 기본기 관련하여 첫 강의를 받아보았습니다. 오버워치라는 게임이 에임도 에임이지만 자리 싸움이 가장 중요하다는 것에 대해 상세하게 설명을 들었습니다. 첫 강의에서 만족하는건 흔치 않은데 좋았습니다." },
  { name: "웅이닮**", rating: 5, review: "예전에 옵치1 초창기에 조금 하다가 접고 다시 복귀해서 게임중인데 게임이 너무 어려워서 강의신청하게되었습니다. 하나하나 세심하게 강의생 눈높이에 맞추셔서 아주 친절하게 이해될때까지 알려주시고, 단점과 장점을 상세히 짚어주시면서 현재 어떤 위치인지 무엇을 더 신경써야 하는지 바른길잡이처럼 피드백 주시는게 너무나도 좋았습니다!!" },
  { name: "touO**", rating: 5, review: "복귀한 후로 천년만년 플다에 살다가, 코치님 피드백 받고 마스터로 금세 올라간 사람입니다. 복귀유저라 키리코도 낯설어했던 저 같은 사람을 개과천선 시켜주셨습니다." },
  { name: "touO**", rating: 5, review: "게임 이해를 쉽게 해주시고, 생각하면서 하게끔 만들어주세요. 아는 것도 많아져서 수행하는 재미가 생깁니다." },
  { name: "touO**", rating: 5, review: "한달 피드백 추천드립니다. 이게 저번 피드백의 연장선으로 피드백 받는 게 되게 효과가 좋더라구요. 모두 코치님께 비법소스 야무지게 받으시고 건승하세요." },
];
...
const MARQUEE_REVIEWS: MarqueeReview[] = [
  ...
  { name: "popu**", rating: 5, review: "피드백 받기 전에는 겨우겨우 한번 가던 티어를 피드백 이후로는 너무나도 쉽게 갔습니다. 선생님의 친절하고 디테일한 코칭에 늘 생각하며 게임하니 진정으로 게임하는법을 깨닫게 되는거 같습니다. 계속 강의 들을 예정입니다 ㅎㅎ", fromTier: "플래티넘", toTier: "다이아몬드" },
  { name: "T1A-**", rating: 5, review: "이번이 한 달 강의의 2회차인데 너무 만족스럽고 좋았습니다.", fromTier: "다이아", toTier: "마스터" },
  { name: "qtwt**", rating: 5, review: "리퍼 플레티넘4에서 마스터5까지 35승 1무 6패로 달성했습니다. 감사합니다!", fromTier: "플레티넘 4", toTier: "마스터 5" },
  { name: "qtwt**", rating: 5, review: "힐러도 브리 원챔으로 다이아4에서 마스터5까지 22승 2패로 달렸습니다. 그마까지 달리기 레츠고!", fromTier: "다이아 4", toTier: "마스터 5" },
  { name: "qtwt**", rating: 5, review: "2주간 수련 끝에 브리 원챔 그마 찍었습니다. 딜러는 플레4에서 마스터5(단 3일), 힐러는 다이아4에서 그마5까지 성공했습니다!", fromTier: "다이아 4", toTier: "그랜드마스터 5" },
];
