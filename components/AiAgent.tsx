...
const TANK_HEROES: Record<string, HeroResult> = {
  ...
  AABA: { name: '둠피스트',   desc: '강력한 주먹 하나로 적진을 붕괴시키고 변수를 만드는 전술가' },
  AABB: { name: '로드호그',   desc: '자립심이 강해 의료 지원 없이도 자가 회복하며 변수를 창출하는 독립형 사냥꾼' },
...
const DPS_HEROES: Record<string, HeroResult> = {
  ...
  AABB: { name: '메이',                  desc: '빙벽 하나로 전장의 지형을 재설계하고 상대의 진입을 차단하는 공간 장악형 전문가' },
  ABAA: { name: '솜브라',                desc: '은신과 해킹 하나로 상대의 연계를 소리 없이 끊어내는 정보전의 설계자' },
  ABAB: { name: '벤처',                  desc: '땅을 파고들어 진입한 뒤 적을 교란시키고 진형을 붕괴시키는 땅굴 돌격대' },
  ABBA: { name: '리퍼',                  desc: '그림자처럼 조용히 잠입해 적진 한가운데서 궁을 집전하는 극적 연출의 대가' },
...
const SUPPORT_HEROES: Record<string, HeroResult> = {
  ...
  AABA: { name: '바티스트',   desc: '불사 장치 하나로 죽음마저 통제하며 묵직한 딜과 힐을 동시에 뿜어내는 전장의 엔지니어' },
  AABB: { name: '아나',       desc: '정밀한 수면총과 생체 수류탄 한 방으로 한타를 완벽하게 재편하는 전장의 총괄 디렉터' },
  ABAA: { name: '우양',       desc: '뻔한 플레이를 거부하고, 예측 불가한 변칙적인 움직임으로 적팀의 설계를 무력화하는 지략가' },
  ABAB: { name: '루시우',     desc: '자유롭게 전장을 누비고 속도 버프와 비트로 팀의 진격 템포를 지배하는 전장의 DJ' },
  ABBA: { name: '미즈키',     desc: '독창적인 유틸리티와 세련된 버프로 나만의 타이밍에 전황을 보좌하는 감각적인 조율사' },
  ABBB: { name: '브리기테',   desc: '방패를 들고 전방으로 돌진하는 힐러계의 이단아' },
  BAAA: { name: '주노',       desc: '매끄러운 궤도 비행과 하이퍼 링을 활용해 아군의 진격 템포를 화끈하게 밀어주는 궤도형 서포터' },
  BAAB: { name: '아나',       desc: '정밀한 수면총과 생체 수류탄 한 방으로 한타를 완벽하게 재편하는 전장의 총괄 디렉터' },
  BABA: { name: '일리아리',   desc: '귀찮은 힐은 태양석에 위임하고, 본인은 치명적인 사격과 딜에 전념하는 파괴적인 효율주의자' },
  BABB: { name: '젠야타',     desc: '힐러의 탈을 쓴 채, 부조화 구슬로 딜러보다 더 매서운 딜을 뽑아내는 무력파 구도자' },
  BBAA: { name: '키리코',     desc: '날카로운 쿠나이로 적을 위협하고 방울로 위기의 아군을 구하는 전장의 구원투수' },
  BBAB: { name: '모이라',     desc: '과학의 이름으로 힐과 딜, 생존까지 내 손으로 직접 해결하는 합리주의자' },
  BBBA: { name: '키리코',     desc: '날카로운 쿠나이로 적을 위협하고 방울로 위기의 아군을 구하는 전장의 구원투수' },
  BBBB: { name: '바티스트',   desc: '불사 장치 하나로 죽음마저 통제하며 묵직한 딜과 힐을 동시에 뿜어내는 전장의 엔지니어' },
}
