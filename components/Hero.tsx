...
const HeroGraphic = dynamic(() => import('./HeroGraphic'), { ssr: false })

/* ──────────────────────────────────────────────
   Typing Hook (Desktop only)
─────────────────────────────────────────────── */
...
/* ──────────────────────────────────────────────
   Mobile Hero — Framer Motion 없음, HeroGraphic/ParticleGrid 없음
─────────────────────────────────────────────── */
function MobileHero() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 w-full py-12">
        <div className="flex flex-col justify-center py-8">
          ...
          <div className="inline-flex items-center gap-2 mb-6 w-fit">
            <span
              className="typo-eyebrow flex items-center gap-1.5 px-3 py-1.5 bg-[#0066ff]/10 border border-[#0066ff]/30 text-[#0066ff]"
          ...
          >
            <span className="text-white">같은 티어에서 1년째 막혔다면?</span>
          </h1>

          {/* Sub headline */}
          <p className="typo-subtitle text-white/80 mb-3">
            정체된 구간에는 이유가 있습니다.
          </p>

          {/* Body */}
          <p className="typo-body text-white/50 mb-8 max-w-[48ch]">
          ...
          <div className="flex flex-col gap-3 mb-10">
            <a
              href="/contact"
              className="typo-button relative inline-flex items-center justify-center gap-3 px-7 py-4 bg-[#0066ff] text-white active:scale-[0.98] transition-colors duration-300"
              style={{
            ...
            <button
              ...
              className="typo-button relative inline-flex items-center justify-center gap-2 px-7 py-4 bg-transparent text-white border border-white/20 active:scale-[0.98] transition-colors duration-300"
          ...
          {/* Strength Cards - 세로 1열 리스트 */}
          <div className="flex flex-col gap-3">
            {STRENGTH_CARDS.map((card) => (
              <div
                key={card.title}
                className="relative p-4 bg-white/[0.03] border border-white/[0.08]"
...
/* ──────────────────────────────────────────────
   Desktop Hero — Framer Motion + HeroGraphic + ParticleGrid + 타이핑
─────────────────────────────────────────────── */
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12 lg:py-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[calc(100dvh-4rem)]">
          ...
          >
            <div className="w-[95%]">
              <HeroGraphic accent="#0066ff" intensity="high" isMobile={false} />
            </div>
          </motion.div>
