...
const MARQUEE_REVIEWS: MarqueeReview[] = [
  ...
  { name: "Ya**", rating: 5, review: "감사합니다. 거의 3달동안 저 알려주실때 정말 열심히 봐주시고 너무 잘 알려주신거 같아서 정말 도움 많이 받았고 정말 많이 실력이 늘었던거 같아요. 이제 제대로 된 프로무대 뛰게 되는데 알려주신거 안까먹고 가서도 열심히 하겠습니다!", fromTier: "그랜드마스터 1", toTier: "챔피언 5" },
